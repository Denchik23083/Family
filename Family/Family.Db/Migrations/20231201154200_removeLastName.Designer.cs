...
namespace Family.Db.Migrations
{
    ...
    [Migration("20231201154200_removeLastName")]
            ...
            modelBuilder.Entity("Family.Db.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            BirthDay = new DateTime(1993, 12, 1, 17, 41, 59, 556, DateTimeKind.Local).AddTicks(4954),
            ...
            modelBuilder.Entity("Family.Db.Entities.Child", b =>
                {
                    ...
                    b.HasOne("Family.Db.Entities.User", "User")
                        .WithOne("Child")
                        .HasForeignKey("Family.Db.Entities.Child", "UserId")
            ...
            modelBuilder.Entity("Family.Db.Entities.Parent", b =>
                {
                    ...
                    b.HasOne("Family.Db.Entities.User", "User")
                        .WithOne("Parent")
                        .HasForeignKey("Family.Db.Entities.Parent", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
